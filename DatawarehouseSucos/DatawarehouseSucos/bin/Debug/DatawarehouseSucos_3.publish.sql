...
CREATE TABLE [dbo].[Fato_001] (
    ...
    CONSTRAINT [PK_Fato_001] PRIMARY KEY CLUSTERED ([Cod_Cliente] ASC, [Cod_Dia] ASC, [Cod_Produto] ASC, [Cod_Organizacional] ASC, [Cod_Fabrica] ASC)
);
...
CREATE TABLE [dbo].[Fato_004] (
    ...
    CONSTRAINT [PK_Fato_004] PRIMARY KEY CLUSTERED ([Cod_Cliente] ASC, [Cod_Dia] ASC, [Cod_Produto] ASC, [Cod_Organizacional] ASC)
);
...
CREATE TABLE [dbo].[Fato_005] (
    ...
    CONSTRAINT [PK_Fato_005] PRIMARY KEY CLUSTERED ([Cod_Produto] ASC, [Cod_Dia] ASC, [Cod_Fabrica] ASC)
);
